                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        변환하여 깃허브에 커밋하는 작업을 진행했습니다.
                        그렇지만, 디자인 시스템을 그대로 적용하려니 하나의
                        컴포넌트에 여러 개의 파일이 필요하고, 배포 시 필요없는
                        패키지가 생겨 힙 메모리 부족이 일어나는 등 활용성이
                        떨어지는 여러 문제점들이 생겼습니다. 컴포넌트 내에 아톰
                        컴포넌트들로 구성이 되어 있는 아토믹 디자인 형태여서
                        오히려 피그마와의 연동이 문제로 작용하였던 것입니다.
                        <strong>
                        ...
                        devDependencies에 추가하지 않은 이유는 개발이 아닌
                        피그마 작업 시에만 필요했기 때문입니다.
                      </p>
                    </li>
                  </ol>
                </details>
            ...
            <article>
              ...
              <main>
                <p>
                  ...
                  <strong>참여도가 적은 동료들을 어떻게 설득할 것인가</strong>
                  라는 질문을 받았고, 그에 대한 해결 방법을 고민했습니다. 그
                  과정에서 동료와 일대일 대화도 하며 그동안 혼자 부담하고 있었던
                  일이 오해를 쌓아왔다고 깨달았습니다. 그래서 스스로 담당하고
                  있던 일들을 나열해 보고 역할을 재분배하였고, 기여도에 대해
                  정확히 명시하여 참여도가 높은 동료를 더 밀어주는 방향으로
                  해결책을 제시하였습니다.
                  <strong>
                    협업하는 과정에서 역할에 대해 다시 생각해 볼 수 있는
                    경험이었고, 문제에 대한 지적보다는 긍정적인 개선 방법에
                    집중하여 결과적으로 긍정적인 피드백을 받을 수 있었습니다.
                  </strong>
                </p>
              </main>
            </article>
